...
def red(n: int) -> FormulationResult:
    ...
    return FormulationResult(name="opt_red", n=n, does_conjecture_hold=is_zero_feasible and not is_positive_feasible, constraint_count =constraints, runtime = end_time - start_time)
